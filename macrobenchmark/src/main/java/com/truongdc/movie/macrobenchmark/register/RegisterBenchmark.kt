...
class RegisterBenchmark {
    ...
    @Test
    fun registerWithCompilationNone() {
        benchmarkRegister(
    ...
    @Test
    fun registerWithCompilationBaselineProfile() {
        benchmarkRegister(
            compilationMode = CompilationMode.Partial(baselineProfileMode = BaselineProfileMode.Require),
        )
    }

    private fun benchmarkRegister(compilationMode: CompilationMode) {
