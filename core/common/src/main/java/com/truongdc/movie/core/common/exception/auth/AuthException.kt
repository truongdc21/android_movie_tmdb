 ...
 */
package com.truongdc.movie.core.common.exception.auth
...
class AuthException(
    val kind: AuthExceptionKind,
    val rootException: Throwable?,
) : AppException(AppExceptionType.AUTH) {

    override fun toString(): String {
        return "AuthException: ${kind.name}"
    }
}

enum class AuthExceptionKind {
    INVALID_EMAIL,
    INVALID_PASSWORD,
}
